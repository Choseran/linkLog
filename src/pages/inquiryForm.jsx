...
export default function InquiryForm() {
  ...
  const [inquiryError, setInquiryError] = useState(false); // 문의유형 선택 에러 상태
  ...
  const submitHandler = async (e) => {
    ...
    const existingInquiries = JSON.parse(
      localStorage.getItem("inquiryList") || "[]",
    );
    const updatedInquiries = [...existingInquiries, newInquiry];
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  className={inquiryError ? "inputError" : ""}
                />
              </td>
            </tr>
            <tr>
            ...
            <tr className="fileUploadTr">
              ...
              <td>
                <label>
                  ...
                  <div
                    className={`fileUploadBox ${isDragging ? "active" : ""}`}
